			...
			<main class="col-8 bd-content">
		        ...
		        <form method="POST" action="classes/CRUD_PLanoEnsino.php">
		         	<div class="form-group row">
					    ...
					    <div class="col-sm-9">
					    	<input class="form-control"type="text" name="Tema" value="<?php echo ?>">
					    </div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-9">
					    	<textarea class="form-control" name="Metodologia" rows="3"></textarea>
					    </div>
					</div>
					<div class="form-group row">
				    	<label for="PlanoEnsino" class="col-sm-3 col-form-label">Carga Horária</label>
					    <div class="col-sm-9">
					    	<input class="form-control" name="C_H" rows="3"></input>
					    </div>
					</div>
					...
					<div class="form-group row">
					    ...
					    <div class="col-sm-9">
					    	<select class="form-control" id="SelProf" name="FK_Prof"><option>Professor</option>
					    		<?php 
